...
def generarCertificado(id):
    ...
    for i in range(len(datos)):
        ...
        nuevo.text(coordenadas, datos[i], fill=color_texto, font=tipo_letra,align="center")
        certificado.save("media/generadosAutomaticos/"+datos[i]+".jpg")
